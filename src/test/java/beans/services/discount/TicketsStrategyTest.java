...
public class TicketsStrategyTest {
    ...
    public void testCalculateDiscount_UserHasDiscount() throws Exception {
        ...
        User userWithDiscount = new User("test@ema.il", bookingDAODiscountMock.userThatBookedTickets, LocalDate.now(), "REGISTERED_USER", "");
    ...
    public void testCalculateDiscount_UserHasNoDiscount() throws Exception {
        User userWithoutDiscount = new User("test@ema.il", "Test Name 2", LocalDate.now().minus(1, ChronoUnit.DAYS), "REGISTERED_USER", "");
